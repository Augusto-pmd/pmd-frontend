  ...
  return (
    <MainLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-pmd-darkBlue mb-2">Operator Dashboard</h1>
          <p className="text-gray-600">Daily operations and tasks</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white rounded-lg shadow-pmd p-6 border-l-4 border-pmd-gold">
            <h3 className="text-sm font-medium text-gray-500 mb-2">Assigned Works</h3>
        ...
        <div className="bg-white rounded-lg shadow-pmd p-6">
          <h2 className="text-xl font-semibold text-pmd-darkBlue mb-4">My Tasks</h2>
